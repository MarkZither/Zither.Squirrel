...
namespace Squirrel.Tests
{
    ...
    {
        // we are upgrading net6 to a minimum version of 6.0.7 to work
        // around a dotnet SDK bug right now.
        [Theory]
        [InlineData("net6", "net6.0.7-x64")]
        [InlineData("net6.0", "net6.0.7-x64")]
        [InlineData("net6-x64", "net6.0.7-x64")]
        [InlineData("net6-x86", "net6.0.7-x86")]
        [InlineData("net3.1", "netcoreapp3.1-x64")]
        [InlineData("netcoreapp3.1", "netcoreapp3.1-x64")]
        [InlineData("net3.1-x86", "netcoreapp3.1-x86")]
        [InlineData("net6.0.7", "net6.0.7-x64")]
        [InlineData("net6.0.7-x86", "net6.0.7-x86")]
